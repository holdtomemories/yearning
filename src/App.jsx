...
useEffect(() => {
  ...
  const doLocate = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => { setLocationStatus("idle"); showToast("could not access your location"); },
  ...
  if (navigator.permissions) {
    navigator.permissions.query({ name: "geolocation" }).then(result => {
      if (result.state === "denied") {
        ...
        showToast("location blocked — enable it in your browser settings", 3500);
      } else {
        // "granted" or "prompt" — call directly, browser will show the prompt
        doLocate();
      }
    }).catch(() => doLocate());
  } else {
